...
export type SignupScreenProps = Readonly<{
  ...
  onBackToSignIn: () => void;
  getFieldError: (field: keyof SignupForm, clientMessage?: string) => string | undefined;
}>;
              ...
              <CardContent>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  <div className="space-y-4 rounded-lg border border-slate-200 bg-slate-50/70 p-4">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        />
                        {getFieldError("username", errors.username?.message) && (
                          <p className="text-sm text-destructive">{getFieldError("username", errors.username?.message)}</p>
                        )}
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        />
                        {getFieldError("email", errors.email?.message) && (
                          <p className="text-sm text-destructive">{getFieldError("email", errors.email?.message)}</p>
                        )}
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        />
                        {getFieldError("password", errors.password?.message) && (
                          <p className="text-sm text-destructive">{getFieldError("password", errors.password?.message)}</p>
                        )}
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        />
                        {getFieldError("confirmPassword", errors.confirmPassword?.message) && (
                          <p className="text-sm text-destructive">{getFieldError("confirmPassword", errors.confirmPassword?.message)}</p>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 rounded-lg border border-slate-200 bg-slate-50/70 p-4">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        />
                        {getFieldError("fullName", errors.fullName?.message) && (
                          <p className="text-sm text-destructive">{getFieldError("fullName", errors.fullName?.message)}</p>
                        )}
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        />
                        {getFieldError("companyName", errors.companyName?.message) && (
                          <p className="text-sm text-destructive">{getFieldError("companyName", errors.companyName?.message)}</p>
                        )}
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        />
                        {getFieldError("phoneNumber", errors.phoneNumber?.message) && (
                          <p className="text-sm text-destructive">{getFieldError("phoneNumber", errors.phoneNumber?.message)}</p>
                        )}
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        />
                        {getFieldError("city", errors.city?.message) && (
                          <p className="text-sm text-destructive">{getFieldError("city", errors.city?.message)}</p>
                        )}
                      </div>
                      ...
                      <div className="md:col-span-2 grid gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          />
                          {getFieldError("countryIso2", errors.countryIso2?.message) && (
                            <p className="text-sm text-destructive">{getFieldError("countryIso2", errors.countryIso2?.message)}</p>
                          )}
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          />
                          {getFieldError("address", errors.address?.message) && (
                            <p className="text-sm text-destructive">{getFieldError("address", errors.address?.message)}</p>
                          )}
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4 rounded-lg border border-slate-200 bg-slate-50/70 p-4">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        />
                        {getFieldError("customerTierCode", errors.customerTierCode?.message) && (
                          <p className="text-sm text-destructive">{getFieldError("customerTierCode", errors.customerTierCode?.message)}</p>
                        )}
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        />
                        {getFieldError("preferredLanguageCode", errors.preferredLanguageCode?.message) && (
                          <p className="text-sm text-destructive">{getFieldError("preferredLanguageCode", errors.preferredLanguageCode?.message)}</p>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col-reverse sm:flex-row gap-3 pt-1">
                    <Button type="button" variant="outline" onClick={onBackToSignIn} disabled={isSubmitting}>
