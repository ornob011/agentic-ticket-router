...
WHERE is_default = TRUE
  AND model_tag <> 'ollama-qwen2.5:7b-instruct';
...
VALUES (0,
        ...
        'Qwen 2.5 7B Instruct (Ollama)',
        '7b',
        'Default model for local Ollama inference (ollama run qwen2.5:7b-instruct) optimized for fast, accurate ticket analysis with maximum determinism (temperature=0.0).',
        'qwen2.5:7b-instruct',
        NULL,
        'Q8_0',
        'ollama://qwen2.5:7b-instruct',
