...
public class DashboardResponseMapper {
    ...
    public ApiDtos.DashboardCustomerSection toCustomerSection(
    ...
    public ApiDtos.DashboardAgentSection toAgentSection(
    ...
    public ApiDtos.DashboardSupervisorSection toSupervisorSection(
    ...
    public ApiDtos.DashboardAdminSection toAdminSection(
    ...
    public List<ApiDtos.TicketSummary> resolveRecentTickets(
        DashboardDto.CustomerData customerData,
        DashboardDto.AgentData agentData
    ) {
    ...
    public Map<TicketQueue, Long> resolveQueueCounts(
        DashboardDto.AgentData agentData
    ) {
